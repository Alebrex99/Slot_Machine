...
# Perchè non si può modificare direttamente costants.py: pyinstaller processo esterno separato, 
# vede contenuto reale di constants.py al momento della build, non può leggere variabili da un processo Python in esecuzione.
# Se il valore sta solo in memoria Python, PyInstaller non lo vede.
# Se il valore sta in un canale condiviso, PyInstaller o l’exe lo vedono: es. .env : letto da file, non da memoria processo python
