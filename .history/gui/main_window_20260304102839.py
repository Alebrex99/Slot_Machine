...
class MainWindow(QWidget):
    def __init__(self, metrics_logger: MetricsLogger):
        ...
        # Tracks the currently displayed symbol on each reel (used for responsive rescaling)
        self.reel_symbols = ["seven", "seven", "seven"]
        # Music state: True = playing
        self._music_on = True
        ...
        for reel in (self.reel1, self.reel2, self.reel3):
            ...
            reel.setMinimumSize(80, 80)  # allow the window to shrink freely
        ...
        # Bottom row: music toggle (left) | GIOCA button (centre)
        bottom = QHBoxLayout()
        ...
        # Initial reel display — must come after setLayout so geometry is known
        self._update_reels()
    ...
    def show_final_result(self):
        ...
        self.reel_symbols = [r1, r2, r3]  # persist for responsive rescaling
        self._update_reels()
