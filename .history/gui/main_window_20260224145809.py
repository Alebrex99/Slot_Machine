...
class MainWindow(QWidget):
    def __init__(self, metrics_logger: MetricsLogger):
        ...
        # Timer animation
        '''
        allo start (spin_timer.start(self.spin_speed)) viene avviato un timer che ogni spin_speed ms (80 ms) chiama la funzione animate_spin, che aggiorna i simboli dei rulli con simboli casuali per creare l'effetto di rotazione.
