...
class MainWindow(QWidget):
    def __init__(self, metrics_logger: MetricsLogger):
        ...
        self.bet_up_btn.setStyleSheet("font-size: 50px; border: 2px solid #333; border-radius: 30px; padding: 2px;")
        ...
        self.bet_down_btn.setStyleSheet("font-size: 50px; border: 2px solid #333; border-radius: 30px; padding: 2px;")
