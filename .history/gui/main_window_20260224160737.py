...
BUDGET = 100
MIN_BET = 0.10
MAX_BET = 2 # non puoi superarla, se inserisce per es. 9 -> riportata a 2, se inserisce un valore valido riportato a multiplo di 0.10 piu vicino
BET_STEP = 0.10
TOTAL_SESSION_BETS = 60 # gioco settato a 60 bets per user: 20 fase PRIMA, 20 fase DURANTE, 20 fase DOPO (condizioni EQUAL, WIN, LOSE)
PHASE_LENGTH = 20
