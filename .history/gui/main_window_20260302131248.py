...
class MainWindow(QWidget):
    ...
    def on_spin(self):  
        ...
        # reward (gain_reale) = bet * multiplier - bet = 0.2 * 15 - 0.2 = 3.0 - 0.2 = 2.8 (vincita netta, che si aggiunge alle monete dell'utente)
        # reward (gain_visualizzato) = bet * multiplier = 0.2 * 15 = 3.0
    ...
    def show_final_result(self):
        ...
        # voglio visualizzare il guadagno inclusa la bet:
        # attualmente: current_reward = 2.8 (vincita netta), bet = 0.2, reward visualizzato = 3.0
        self.coins += reward
        self.update_coin_label()
        self.validate_bet()
