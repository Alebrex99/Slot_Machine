...
class MainWindow(QWidget):
    def __init__(self):
        ...
        #voglio rendere il valore della bet isneribile a mano con tastiera, quindi uso setFocusPolicy(Qt.StrongFocus) per permettere al QLabel di ricevere il focus e sovrascrivere il metodo keyPressEvent per gestire l'input da tastiera
        self.bet_display.setFocusPolicy(Qt.StrongFocus)
