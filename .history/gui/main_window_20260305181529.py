    ...
    def testing_statistics_v2(self, remote_researcher: RemoteResearcher) -> None:
        ...
        for test in range(TOTAL_TESTS):
            ...
            if test > 0:
                ...
                print (f"[TEST] Starting first test with initial condition: {remote_researcher.get_current_condition()}")
            ...
            # Al termine dell'ultimo test, _execute_spin_logic chiama self.close() → SESSION_END.
