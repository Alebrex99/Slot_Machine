...
class MainWindow(QWidget):
    def __init__(self, metrics_logger: MetricsLogger):
        ...
        self.music_btn.setFixedWidth(110)
        ...
        top.addStretch(1)
        top.addWidget(self.watermark, 0, Qt.AlignCenter)
        top.addStretch(1)
        ...
        # NEW: Bottom Layout
        # single bottom row — music (left) | stretch | GIOCA (centre) | stretch
        bottom = QHBoxLayout()
        bottom.addWidget(self.music_btn)
        bottom.addStretch(1)
        bottom.addWidget(self.spin_btn)
        bottom.addStretch(1)
        bottom.addSpacing(self.music_btn.sizeHint().width())  # balance the music button's fixed width on the right for better centering of the spin button
