...
class MainWindow(QWidget):
    ...
    def show_final_result(self):
        ...
        # data poi la reward (gain visualizzato) = bet * multiplier
        # quindi facendo coins + reward (gain visualizzato) -> coins effettivi post giocata = coins - bet + bet*multiplier 
