...
from core.constants import INITIAL_BUDGET, MIN_BET, MAX_BET, BET_STEP, TOTAL_SESSION_BETS, PHASE_LENGTH, TOTAL_SESSION_TESTS
...
class MainWindow(QWidget):
    ...
    def _execute_spin_logic(self) -> None:
        ...
        # TEST VERSION 2: 50 STRESS SESSIONS TEST PER CONDIZIONE, POI CHIUSURA: >= TOTAL_SESSION_BETS*TOTAL_SESSION_TESTS
        # Auto-close after the configured number of bets
        if self.bet_counter >= TOTAL_SESSION_BETS*TOTAL_SESSION_TESTS: # 60bets * 50sessions = 3000
