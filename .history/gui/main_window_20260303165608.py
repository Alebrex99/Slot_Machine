...
class MainWindow(QWidget):
    ...
    def testing_statistics(self, researcher) -> None:
        ...
        self.coins = INITIAL_BUDGET
        self.bet_counter = 0
        self.current_bet = MIN_BET  # TODO da rendere casuale
        ...
        for _ in range(TOTAL_SESSION_BETS):
            self.current_bet = random.choice(range(int(MIN_BET*10), int(MAX_BET*10)+1, int(BET_STEP*10))) / 10.0  # puntata casuale tra MIN_BET e MAX_BET con step di BET_STEP
