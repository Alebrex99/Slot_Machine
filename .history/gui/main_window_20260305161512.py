...
class MainWindow(QWidget):
    def __init__(self, metrics_logger: MetricsLogger):
        ...
        self.bet_display.setFixedHeight(60)  # BUG1: prevent vertical compression / content clipping
        ...
        self.bet_up_btn.setFixedHeight(60)  # BUG1: prevent overlap when window shrinks vertically
        ...
        self.bet_down_btn.setFixedHeight(60)  # BUG1: prevent overlap when window shrinks vertically
