...
class MainWindow(QWidget):
    def __init__(self, metrics_logger: MetricsLogger):
        ...
        self.bet_up_btn.setMinimumHeight(70)  # BUG1: same floor as bet_display; prevents overlap
        ...
        self.bet_down_btn.setMinimumHeight(70)  # BUG1: same floor as bet_display; prevents overlap
