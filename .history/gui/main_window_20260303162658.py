...
class MainWindow(QWidget):
    ...
    def _execute_spin_logic(self) -> None:
        ...
        # FIX: OLD code called spin_reels() with no args and calculate_reward([r1,r2,r3], bet)
        # which are the OLD probabilistic signatures → runtime crash with current slot_logic.
        # CORRECTED: mirrors the exact real gameplay pipeline from on_spin + show_final_result.
        #
        # OLD (broken):
