...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.coin_label.setMinimumHeight(50)
        self.coin_label.setMinimumWidth(140)
        self.coin_label.setStyleSheet("font-size: 28px; font-weight: 700;")
        self.coin_label.setSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        ...
        self.watermark.setStyleSheet("font-size: 50px; font-weight: 600;")
        ...
        #            LAYOUTS
        # ===============================
        #use BOX layout (H and V) to organize widgets horizontally and vertically
        top = QHBoxLayout()
        top.setContentsMargins(12, 12, 12, 8)
        top.setSpacing(12)
        top.addWidget(self.coin_label, 0)
        top.addWidget(self.redeem_btn, 0)
        top.addStretch(1)
        top.addWidget(self.watermark, 3)
        top.addStretch(1)
