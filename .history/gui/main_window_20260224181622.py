...
class MainWindow(QWidget):
    ...
    def on_spin(self):    
        # TODO è molto importante che quando l'app si chiude, alla successiva sessione le metriche vengano appese nel file
        ...
        # increment bet counter for this play
        self.bet_counter += 1
    ...
    def testing_statistics(self, researcher) -> None:
        ...
        for expected_value in expected_values_used:
            ...
            # enable metrics for this test (default condition 'E') and reset counters
            self._metrics.enable_metrics("E")
            self.bet_counter = 0
            self.coins = 1000.0
            self.update_coin_label()
            self.update_bet_display()
