...
class MainWindow(QWidget):
    ...
    def _get_symbol_size(self) -> int:
        """Compute reel pixmap size that fits the current window dimensions, respecting reel min/max size."""
        ...
        # Clamp between reel's setMinimumSize(100) and setMaximumSize(700)
