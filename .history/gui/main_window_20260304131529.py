...
class MainWindow(QWidget):
    def __init__(self, metrics_logger: MetricsLogger):
        ...
        self.bet_display.setObjectName("bet_display")
        self.bet_display.setAlignment(Qt.AlignCenter)
        self.bet_display.setMaximumWidth(400)
        ...
        self.bet_up_btn.setMaximumWidth(400)
        self.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        ...
        self.bet_down_btn.setMaximumWidth(400)
        self.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        ...
        self.coin_label.setMinimumHeight(150)
        ...
        # OLD: bet_controls.addStretch()  # removed — QHBoxLayout already equalises row heights
        ...
        # OLD: redeem_layout.addStretch()  # removed — same reason as above
        ...
        # OLD: top.addLayout(bet_controls)                 # no stretch → watermark was off-centre
        # OLD: top.addStretch()                            # replaced by stretch factor on addLayout
        top.addWidget(self.watermark, 0, Qt.AlignCenter)   # 0 stretch → natural width, truly centred
        # OLD: top.addWidget(self.watermark)               # no AlignCenter flag
        # OLD: top.addStretch()                            # replaced by stretch factor on addLayout
        ...
        # OLD: bottom.addWidget(self.music_btn)              # no stretch → asymmetric
        # OLD: bottom.addStretch(1)                          # replaced by stretch factor on addWidget
        bottom.addWidget(self.spin_btn, 0, Qt.AlignCenter)   # NEW: stretch=0, centred      — mirrors addWidget(watermark, 0, AlignCenter)
        # OLD: bottom.addWidget(self.spin_btn)               # no alignment flag
        # OLD: bottom.addStretch(1)                          # replaced by symmetric addStretch below
        # OLD: bottom.addSpacing(...)                        # replaced by pure stretch — no sizeHint hack needed
        bottom.addStretch(1)                                 # NEW: right stretch mirrors left → spin_btn truly centred
