...
class MainWindow(QWidget):
    def __init__(self, metrics_logger: MetricsLogger):
        ...
        for reel in (self.reel1, self.reel2, self.reel3):
            ...
            reel.setMinimumSize(80, 80)
            reel.setMaximumSize(700, 700)  # minimum so the window can shrink freely
        ...
        reels.addStretch()
        reels.addWidget(self.reel1, 3)
        reels.addWidget(self.reel2, 3)
        reels.addWidget(self.reel3, 3)
        reels.addStretch(1)
