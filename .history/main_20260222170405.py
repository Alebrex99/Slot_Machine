...
if __name__ == "__main__":
    ...
    # se TEST_MODE testing_statistic chiama: enable_metrics per abilitare metriche + set_expected_value per iterare su tutti i valori di CONVERTING_TABLE durante il test automatico
