...
if __name__ == "__main__":
    ...
    # se TEST_MODE l'expected value è settato da testing_statistics che chiama enable_metrics
    # se non TEST_MODE, l'expected_value è settato in input data e enable_metrics è chiamato dal researcher
    remote_researcher.start_session()  # Log session start and enable metrics with expected value corrente
