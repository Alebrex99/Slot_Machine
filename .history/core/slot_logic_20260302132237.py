...
def calculate_reward(budget_before_spin, current_bet):
    ...
    if current_bet_counter in PHASES["PHASE_BEFORE"]:
        ...
        if win:
            ...
            # Una volta trovato simbolo e occorrenze, bisogna ritornare la reward effettiva (e visualizzata) da mostrare all'utente, che è data da bet * moltiplicatore (reward visualizzata) ma anche da bet * moltiplicatore - bet (reward reale, che si aggiunge alle monete dell'utente):
