...
- chiamare update_expected_value() in slot_logic (cambia WIN_PERCENTAGE)
...
class RemoteResearcher:
    ...
    def set_input_data(self) -> None:
        ...
        # Attiva TEST_MODE se il ricercatore lo richiede
        if self._input_data.upper() == "TEST":
            self._test_mode = True
            print("[RemoteResearcher] TEST_MODE abilitato — la GUI sarà disabilitata durante il test.")
        else:
    ...
    def set_expected_value(self, expected_value: float) -> None:
        """Aggiorna l'expected value: modifica WIN_PERCENTAGE in slot_logic e aggiorna lo stato interno.

        Questo è l'UNICO metodo autorizzato a chiamare update_expected_value().
        ...
        update_expected_value(expected_value)  # UNICA chiamata autorizzata a update_expected_value
    ...
    def remote_change_expected_value(self, new_expected_value: float) -> None:
        ...
        Args:
            new_expected_value: Nuovo valore atteso inviato dal PC del ricercatore.
        """
    ...
    def remote_charge_coin(self, amount: float, current_coins: float) -> None:
        ...
        Args:
            amount: Ammontare di coins da aggiungere.
            current_coins: Saldo coins corrente dopo la ricarica.
        """
