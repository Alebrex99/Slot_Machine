...
class RemoteResearcher:
    """Gestisce i parametri di sessione forniti dal ricercatore solo prima l'esecuzione.
    ...
    def __init__(self, metrics_logger) -> None:
        ...
        self._current_condition: str = "U"  # valore di default
    ...
    def set_input_data(self) -> None:
        ...
        if self._input_data.upper() == "TEST":
            ...
            self.set_condition(10)
            print(f"[RemoteResearcher] Avvio con DATA='{self._input_data}' condition={self._current_condition}")
