...
def lose_increase(budget_before_spin, current_bet_counter, current_bet):
    ...
    expected_lose_value = round(expected_percentage_decrease * initial_budget_during + current_bet, 2) # calcolo la perdita attesa per questa bet, che è l'incremento percentuale atteso moltiplicato per il budget iniziale della fase, più la bet corrente
    pass
