...
class RemoteResearcher:
    ...
    def set_input_data(self):
        ...
        self.input_value = input("Insert DATA: ")  # Keep the application running until user input
        input("Press ENTER to start application with DATA: " + self.input_value)  # Wait for user to press Enter again before starting the application
        print("Starting application... ", self.input_value)
    ...
    def start_session(self):
        ...
        self._metrics_logger.enable_metrics(expected_value=0.33)  # Enable logging with desired expected value
