...
class MetricsLogger:
    ...
    # Se voglio loggare anche il numero di bet, devo passarlo come argomento alla funzione log_bet e log_result, in modo da avere un riferimento temporale preciso su quale bet è stata fatta e quale risultato ha dato.
    def log_bet(self, bet_number: int, bet: float, coin_before: float) -> None:
