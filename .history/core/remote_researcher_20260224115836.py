...
class RemoteResearcher:
    ...
    def __init__(self, metrics_logger) -> None:
        ...
        self._current_condition: str = "E"  # valore di default EQUAL (gli altri sono "WIN" e "LOSE")
    ...
    def set_input_data(self) -> None:
        ...
        if self._input_data.upper() == "TEST":
            ...
            print(f"[RemoteResearcher] Avvio con CONDITION='{self._input_data}' condition={self._current_condition}")
