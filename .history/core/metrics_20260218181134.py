...
class MetricsLogger:
    ...
    # In questo caso, metrics_enabled e current_expected_value possono essere letti 
    # come se fossero variabili, ma in realtà eseguono del codice quando vengono accessi.

    @property
    """
    Returns whether gameplay event logging is active.

    The @property decorator converts this method into a getter property, allowing
    it to be accessed as an attribute (e.g., obj.metrics_enabled) rather than as
    a method call (e.g., obj.metrics_enabled()). This provides a cleaner interface
    while maintaining encapsulation by controlling access to the private attribute
    _metrics_enabled.
    """
