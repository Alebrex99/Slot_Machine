...
def calculate_reward(budget_before_spin, current_bet):
    ...
    if current_bet_counter in PHASES["PHASE_BEFORE"]:
        ...
        if win:
            ...
            reward = current_bet * real_multiplier # la reward effettiva è data dalla puntata moltiplicata per il moltiplicatore reale, più la puntata stessa che viene restituita in caso di vittoria
            return reward
        else: 
            return 0
