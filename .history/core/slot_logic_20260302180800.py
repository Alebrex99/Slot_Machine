...
def calculate_reward(budget_before_spin, current_bet_counter, current_bet):
    ...
    if current_bet_counter in PHASES["PHASE_DURING"]:
        print(f"FASE DURING {current_bet_counter}: condizione {condition}, aspettarsi un aumento (WIN), una diminuzione (LOSE) o rimanere stabili (EQUAL) rispetto al budget iniziale")
