...
def calculate_reward(budget_before_spin, current_bet_counter, current_bet, initial_budget_after=None):
    ''' 
        ...
        - 
    '''
    global initial_budget_before, initial_budget_during
    ...
    if current_bet_counter in PHASES["PHASE_AFTER"]:
        ...
        # initial_budget_after is passed in by the caller (main_window.py tracks the phase-start budget)
        pass
