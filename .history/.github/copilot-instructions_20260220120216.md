...
core/remote_researcher.py   → ONLY class allowed to call update_expected_value() in slot_logic
...
- `RemoteResearcher` stubs (`remote_change_expected_value`, `remote_charge_coin`, `remote_send_message`) are reserved for future TCP integration — do not repurpose them.
