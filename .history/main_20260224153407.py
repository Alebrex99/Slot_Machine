...
if __name__ == "__main__":
    ...
    remote_researcher.start_metrics()  # Log session start and enable metrics with condition
    
    window = MainWindow(metrics_logger=metrics_logger)
    window.show()

    # TODO: il test automatico deve essere modificato visto il cambiamente della logica (ora ho le conditions)
